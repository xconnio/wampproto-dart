...
void main() {
  group("Challenge", () {
    ...
    test("JSONSerializer", () async {
      ...
      var command = "message challenge ${msg.authMethod} -e ticket=abc --serializer json";
    ...
    test("CBORSerializer", () async {
      var msg = Challenge("ticket", {"ticket": "abc"});
      var command = "message challenge ${msg.authMethod} -e ticket=abc --serializer cbor --output hex";
    ...
    test("MsgPackSerializer", () async {
      var msg = Challenge("ticket", {"ticket": "abc"});
      var command = "message challenge ${msg.authMethod} -e ticket=abc --serializer msgpack --output hex";
